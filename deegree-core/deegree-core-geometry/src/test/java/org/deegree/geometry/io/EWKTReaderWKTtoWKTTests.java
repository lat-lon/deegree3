...
public class EWKTReaderWKTtoWKTTests {
	...
	private EWKTReader reader = new EWKTReader();
	...
	private static Stream<Arguments> data() {
		...
		return Stream.of(
				Arguments.of(0, "LINESTRING (60 380,60 20,200 400,280 20,360 400,420 20,500 400,580 20,620 400)"),
				Arguments.of(1, "MULTIPOINT (111.0 -47.0,110.0 -46.5)"),
				Arguments.of(9,
				...
				Arguments.of(0, "MULTICURVE ((0 0,5 5),CIRCULARSTRING (4 0,4 4,8 4))"),
				Arguments.of(0,
						"MULTICURVE ((100 100,120 120),COMPOUNDCURVE (CIRCULARSTRING (0 0,2 0,2 1,2 3,4 3),(4 3,4 5,1 4,0 0)))"),
				Arguments.of(0, "POINT (1 2)"), Arguments.of(0, "LINESTRING (0 2,2 0,8 6)"),
				Arguments.of(0,
	...
	@ParameterizedTest
	@MethodSource("data")
	public void verifyWKT(int decimalPlaces, String wkt) throws Exception {
